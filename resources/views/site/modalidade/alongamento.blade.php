...
@section('title','Modalidade - Alongamento')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcumb-content">
                        <h1 class="breadcumb-title">Detalhes de Alongamento</h1>
                        <ul class="breadcumb-menu">
                            <li><a href="index.html">HOME</a></li>
                            <li class="active">ALONGAMENTO</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xxl-8 col-lg-7">
                    <div class="service-page-single">
                        <div class="page-img mb-50">
                            <img src="{{ asset('img/modalidade/alongamento.jpg') }}" alt="img">
                        </div>
                        <div class="page-content">
                            <h2 class="page-title">Alongamento</h2>
                            <p class="mb-30">Em nosso espaço dedicado ao alongamento, convidamos você a mergulhar em uma experiência revigorante que estende além dos limites do físico, alcançando uma harmonia profunda entre corpo e mente. Nossas aulas são cuidadosamente projetadas para proporcionar momentos de relaxamento e renovação, promovendo a flexibilidade e a liberdade de movimento. Guiados por instrutores especializados, os participantes são conduzidos por sequências de alongamento que não apenas aliviam a tensão muscular, mas também incentivam uma consciência plena do corpo.</p>
                            <p class="mb-50">Seja você um atleta dedicado, um profissional atarefado ou alguém em busca de um refúgio para o estresse diário, nosso espaço de alongamento oferece um santuário onde a busca pela serenidade se encontra com os benefícios tangíveis para o corpo, resultando em uma sensação de bem-estar que transcende a sala de aula. Descubra o poder transformador do alongamento que vai além dos músculos, nutrindo sua vitalidade e equilíbrio interior.</p>
                            ...
                            <h3 class="page-subtitle mb-0">Porque escolher-nos?</h3>
                            <div class="service-page-list checklist mb-50" data-bg-src="{{ asset('img/modalidade/alongamento.jpg') }}">
                                <ul>
